...
Route::group(['prefix' => 'auth', 'namespace' => 'Itsaninho\Filemanager\Http'] , function() {
    Route::post('login', 'FilemanagerController@login');
});

Route::group(['prefix' => 'filemanager', 'namespace' => 'Itsaninho\Filemanager\Http', 'middleware' => 'jwt.auth'] , function() {
